...
2026-09-11：按开发与发布规范完成应用、容器和邮件栈验证。原生 amd64/arm64 上游测试及真实协议、鉴权、升级回滚门禁均已通过，远程记录见 [CI](https://github.com/logdns/imyemail/actions/runs/34569714342)。Dovecot 来源、数据兼容性和容器剩余风险见 [运维说明](OPERATIONS.md)。
