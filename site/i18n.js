(() => {
  ...
  const english = {
    ...
    "文档": "Docs",
    "开始部署": "Deploy now",
    "最新版本 v1.3.18": "Latest release v1.3.18",
    "自己的邮箱，": "Your email.",
    ...
    "存储空间": "Storage",
    "Release v1.3.18 已成功发布": "Release v1.3.18 published successfully",
    ...
    "会话阅读、全文搜索、草稿、定时发送、标签、自定义文件夹、联系人、签名、导入导出和多邮箱切换；三套模板适配移动端与超宽屏。": "Threaded reading, full-text search, drafts, scheduled delivery, labels, folders, contacts, signatures, import/export, multiple mailboxes, and three responsive UI templates.",
