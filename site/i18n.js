(() => {
  ...
  const english = {
    ...
    "文档": "Docs",
    "开始部署": "Deploy now",
    "最新版本 v1.3.15": "Latest release v1.3.15",
    "自己的邮箱，": "Your email.",
    ...
    "存储空间": "Storage",
    "Release v1.3.15 已成功发布": "Release v1.3.15 published successfully",
    ...
    "会话阅读、全文搜索、草稿、定时发送、标签、自定义文件夹、联系人、签名、导入导出和多邮箱切换；双模板适配移动端与超宽屏。": "Threaded reading, full-text search, drafts, scheduled delivery, labels, folders, contacts, signatures, import/export, multiple mailboxes, and two responsive UI templates.",
    "可视化管理后台": "Visual administration",
    "账号、权限、域名、DNS、邮箱、队列、全域公告、三语言默认设置、界面模板和系统统计集中管理。": "Manage accounts, permissions, domains, DNS, mailboxes, queues, announcements, a three-language default, UI templates, and system analytics in one place.",
    ...
    "更新前自动备份，后台异步更新，保留上一镜像并支持二次确认回滚。": "Automatic pre-update backups, asynchronous updates, preserved previous images, and confirmed rollback.",
    ...
    "安装完成：打开你的 Webmail 地址": "Installation complete: open your Webmail URL",
