(() => {
  ...
  const english = {
    ...
    "文档": "Docs",
    "开始部署": "Deploy now",
    "最新版本 v1.3.14": "Latest release v1.3.14",
    "自己的邮箱，": "Your email.",
    ...
    "存储空间": "Storage",
    "Release v1.3.14 已成功发布": "Release v1.3.14 published successfully",
    ...
    "账号、权限、域名、DNS、邮箱、队列、全域公告、界面模板和系统统计集中管理。": "Manage accounts, permissions, domains, DNS, mailboxes, queues, announcements, UI templates, and system analytics in one place.",
